...
{
    /* 模板赋值 */
    $smarty->assign('ur_here',     $_LANG['madmin_list']);
   // $smarty->assign('action_link', array('href'=>'privilege.php?act=add', 'text' => $_LANG['madmin_add']));
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    admin_priv('admin_add');
     ...
     /* 模板赋值 */
    $smarty->assign('ur_here',     $_LANG['madmin_add']);
    $smarty->assign('action_link', array('href'=>'privilege.php?act=list', 'text' => $_LANG['madmin_list']));
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link', array('text' => $_LANG['madmin_list'], 'href'=>'privilege.php?act=list'));
