...
"(comment_type,id_value,email,qq,user_name,yhname,comment_zhuti,gsmc,content,address,shouji,fax,faq,comment_rank,add_time,ip_address,status,parent_id,user_id,img,contact_tel) VALUES " .
           "('".$cmt->type."','".$cmt->id."','$email','".$cmt->qq."','$user_name','".$cmt->yhname."','".$cmt->comment_zhuti."','".$cmt->gsmc."','".$cmt->content."','".$cmt->address."','".$cmt->shouji."','".$cmt->fax."','".$cmt->faq."','".$cmt->rank."','".gmtime()."','".real_ip()."','$status','0','$user_id','".$cmt->img_file."','".$cmt->contact_tel."')";
